...
return array(
	'ServerAddress'				=> '51.79.157.53',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> 'web',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'ayanami222',		// Installer/updater password.
	...
	'ThemeName'					=> array('default', 'bootstrap','fluxcp_theme_iro_1.1',), // Names of the themes you would like list for use in the footer. Themes are in FLUX_ROOT/themes.
